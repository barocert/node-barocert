...
BaseService.addMethod(BaseService.prototype, '_sha256_base64url_file', function(target, success, error) {
  BaseService._sha256_base64url_file({
    target,
    success: function (response) {
      if (success) success(response);
    },
...
BaseService.addMethod(KakaocertService.prototype, 'verifyIdentity', function (ClientCode, ReceiptID, success, error) {
  ...
  this._executeAction({
    uri: '/KAKAO/Identity/Verify/' + ClientCode + '/' + ReceiptID,
    Method: 'POST',
    success: function (response) {
      if (success) success(response);
    },
...
BaseService.addMethod(KakaocertService.prototype, 'verifySign', function (ClientCode, ReceiptID, success, error) {
  ...
  this._executeAction({
    uri: '/KAKAO/Sign/Verify/' + ClientCode + '/' + ReceiptID,
    Method: 'POST',
    success: function (response) {
      if (success) success(response);
    },
...
BaseService.addMethod(KakaocertService.prototype, 'verifyMultiSign', function (ClientCode, ReceiptID, success, error) {
  ...
  this._executeAction({
    uri: '/KAKAO/MultiSign/Verify/' + ClientCode + '/' + ReceiptID,
    Method: 'POST',
    success: function (response) {
      if (success) success(response);
    },
...
BaseService.addMethod(KakaocertService.prototype, 'verifyCMS', function (ClientCode, ReceiptID, success, error) {
  ...
  this._executeAction({
    uri: '/KAKAO/CMS/Verify/' + ClientCode + '/' + ReceiptID,
    Method: 'POST',
    success: function (response) {
      if (success) success(response);
    },
